You need Java 18 or 21 to play 1.20.1 Modpacks. Recommended versions can be found on either:

- https://adoptium.net/temurin/releases/     (Make sure to get the 64bit .msi file, if using Windows)
- https://www.graalvm.org/downloads/      (GraalVM Community Edition has been shown to give slightly better Minecraft server performance, but you'll need specific flags - read the brucethemoose github link below)
If your server still doesn't launch with Java 18/21, the simplest fix is usually to uninstall other Java versions! These can be found by going to Programs and Features, then typing the letter "j" to search for versions of Java.
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
